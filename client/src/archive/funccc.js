...
class ScreenRecorder extends Component {
    ...
    render() {
        ...
        const closeBtn = (!this.props.isSceenSharing) ?
            (((( this.props.isSharingCompleted) && !this.props.isSaved)|| this.state.doneCalling ||  this.state.answerFrmPeer)?(null) :(<Button  style={{margin:"5px"}} close onClick={closeFunction} />)):
            (null)
        ...
        if(!this.state.saveinitiated) {this.savefilePrivate()}
            MessageDisconnected = (
                <div>
