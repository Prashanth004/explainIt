                ...
                <div className="shapes">
                    <div className="imagesShapes">
                        <img onClick={this.props.addrect}
                            draggable={true} height="100%" width="100%" object-fit="contain" alt=" " src={require("../images/rect1.PNG")}></img>
                    </div>
                    <div className="imagesShapes">
                        <img onClick={this.props.addcrc}
                             draggable={true} height="90%" width="90%" object-fit="contain" alt="" src={require("../images/circle.jpg")}></img>
                    </div>
                    <div className="imagesShapes">
                    ...
                    <div className="imagesShapes">
                        <img onClick={this.props.addRountRect}
                             draggable={true} height="100%" width="100%" object-fit="contain" alt="" src={require("../images/rountRect.PNG")}></img>
                    </div>
